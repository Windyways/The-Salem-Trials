...
namespace TheSalemTrials
{
    ...
    public Il2CppSystem.Collections.Generic.List<Character> SortList(Il2CppSystem.Collections.Generic.List<Character> list)
        ...
        /*[HarmonyPatch(typeof(Gameplay), "OnCharacterReveal")] - Not using this for now.
        public static class w_AnyRevealPatch
        {
            public static ETriggerPhase AnyReveal = (ETriggerPhase)999999990;
            [HarmonyPrefix]
